...
<?php include 'top-container.php';?>
    <div class="title-container">
        <h2>Fertilizer Stock details</h2>
    </div>
    <div class="middle-container">
        ...
        <div class="table-row">
            <div class="table-row-btn buy-btn"><a href="<?php echo URL?>Supervisor/fertilizerInStock"><button class="table-btn">Fertilizer In-Stock</button></a></div>
            <div class="table-row-btn use-btn"><a href="<?php echo URL?>Supervisor/fertilizerOutStock"><button class="table-btn">Fertilizer Out-Stock</button></a></div>
        </div>
