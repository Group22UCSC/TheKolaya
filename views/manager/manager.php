  ...
  <div class="middle-conatiner">
    ...
    <div class="middle-left">
        <div class="btn-list">
          <a href="<?php echo URL?>manager/viewAccount"> <button class="btn btn-account"><i class="fas fa-user"></i> ACCOUNTS</button></a>
           ...
           <a href="<?php echo URL?>manager/viewPayments"><button class="btn btn-payments"><i class="fas fa-hand-holding-usd"></i> PAYMENTS</button>
    ...
    <div class="middle-right">
        <p class="long-copy">
         ...
         <a href="<?php echo URL?>manager/viewStock"><button class="btn btn-stock"><i class="fas fa-chart-line"></i> STOCK DETAILS</button>
    </div>
