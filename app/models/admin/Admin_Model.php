...
////////////////////// update accounts/////////////////////////////
        ...
        $query= "UPDATE user SET user_type='$_POST[user_type]',name='$_POST[name]',contact_number='$_POST[contact_number]',address='$_POST[address]',password=SHA('$_POST[password]') WHERE user_id='$_POST[user_id]'";
